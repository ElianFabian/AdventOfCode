...
object PuzzleYear2015Day13 : AocPuzzle(2015, 13)
{
    ...
    override fun getResultOfPartOne(): Int
    {
        ...
        val allGuestNames = listOfGuestInfo.map { it.selfName }.distinct()
...
private fun getHappinessUnitsVariationByGuestByGuest(listOfGuestInfo: List<GuestInfo>): Map<String, Map<String, Int>>
{
    ...
    for (guestInfo in listOfGuestInfo) guestInfo.apply()
    {
        happinessUnitsByGuestByGuest.putOrUpdate(selfName, mutableMapOf(neighborName to happinessUnitsVariation))
        {
            it.apply { put(neighborName, happinessUnitsVariation) }
        }
    }
